...
def check_posture(pose_landmarks):
    ...
    is_posture_correct = all([right_shoulder_angle >= CORRECT_POSTURE_THRESHOLD['shoulder'],
                              neck_angle >= CORRECT_POSTURE_THRESHOLD['neck'],
                              right_neck_angle <= CORRECT_POSTURE_THRESHOLD['upper_neck'],
                              right_hip_angle <= CORRECT_POSTURE_THRESHOLD['hip'],
                              right_knee_angle <= CORRECT_POSTURE_THRESHOLD['knee']])
    print(neck_angle, "Neck Angle ")
    print(right_neck_angle, "Right Neck Angle ")
...
img = cv2.imread("side_images/image25.png", 1)
